<!-- This shows all the hotel you have registerd in your DB. It is connected with All Hotel button of Navbar when you are not signed in -->
...
<body>
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            //Finding minimum-maximum price of the room
            ...
            //printing the hotel info in a card
            echo '<div class="col-md-12 col-md-pull-3" style="border-style:groove; width:180%">
                    
                      
            <div class="search-result-item-body">
                <div class="row">
                    <div class="col-sm-9">
                    <a class="image-link" href="hotel_details.php?h_id=' . $row["h_id"] . '"><img class="image" src="' . $imageSrc . '" style="height:200px; width:200px; "> 
                </a>
        ...
        //this part will get executed if there is no hotel in DB. It will show a jumbotron saying no hotel found.
    } else {
        echo '<div class="jumbotron jumbotron-fluid"> 
                    <div class="container">
                        <p class="display-4">No Room Found</p>
                    </div></div>';
    }
    mysqli_close($conn);
    ?>
